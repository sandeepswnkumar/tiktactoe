...
box5.addEventListener('click', () => {
    if (box5.innerHTML === `<div class="active disable">${temp}</div>`) {
        ...
        // setTimeout(()=>{
        //     box1.innerHTML =`<div class="active disable">O</div>`;
        // }, 1000)
...
box6.addEventListener('click', () => {
    if (box6.innerHTML === `<div class="active disable">${temp}</div>`) {
        ...
        temp = tikToe;
        // setTimeout(()=>{
        //     box5.innerHTML =`<div class="active disable">O</div>`;
        // }, 1000)
        if (box6.innerText === "X") {
            box6.style.color = "#ff0000"
        }
        if (box6.innerText === "O") {
            box6.style.color = "#07215f"
        }
        kik();
    }
